...
//		for(int i= 0 ; i < 10; i++) {
			allocator.setRandomSeed(7);
			Experiment experiment1 = new Experiment(allocator1, dataset, 7);
			experiment1.run();
//		}
...
//		for(int i= 0 ; i < 10; i++) {
			allocator.setRandomSeed(7);
			Experiment experiment2 = new Experiment(allocator2, dataset, 7);
			experiment2.run();
//		}
...
//		for(int i= 0 ; i < 10; i++) {
			allocator.setRandomSeed(7);
			Experiment experiment3 = new Experiment(allocator3, dataset, 7);
			experiment3.run();
//		}
...
//		for(int i= 0 ; i < 10; i++) {
			allocator.setRandomSeed(7);
			Experiment experiment4 = new Experiment(allocator4, dataset, 7);
			experiment4.run();
//		}
